      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        <div className="mx-auto flex max-w-[600px] flex-col items-center gap-3 text-center">
          ...
          <p className="max-w-[48ch] text-[#221F1A]/60">
            ...
            for its rashi, set in silver or gold plate and finished by hand.
          </p>
        </div>
        ...
        <ul
          ref={gridRef}
          role="list"
          className="mt-14 grid grid-cols-2 gap-x-4 gap-y-9 sm:mt-16 sm:gap-x-6 sm:gap-y-11 lg:grid-cols-3 xl:grid-cols-4"
        >
          {visible.map((product, index) => (
            <li
              key={product.id}
              className="rashi-card-reveal"
              style={{
